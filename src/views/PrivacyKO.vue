      ...
      <section class="section-shaped my-0">
        ...
        <div class="container shape-container d-flex">
          <div class="col px-0">
            <div class="row">
              <div class="col-lg-12">
                <h1 class="display-6 text-center text-white">개인정보 취급방침</h1>
              </div>
            </div>
          </div>
        </div>
...
helpus는 정보통신망 이용촉진 및 정보보호 등에 관한 법률, 개인정보보호법, 통신비밀보호법, 전기통신사업법, 등 
          ...
          <div class="col-md-12">
            ...
            <div class="col-md-12">
            <p class="lead">서비스 이용 과정에서 이용자로부터 수집하는 개인정보</p>
            <p>
          ...
          <div class="col-md-12">
            ...
            <div class="col-md-12">
            <p class="lead">개인정보 보유기간, 파기방법 및 이용기간</p>
            <p>
